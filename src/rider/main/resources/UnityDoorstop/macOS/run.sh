...
# Final setup
doorstop_directory="${BASEDIR}/Doorstop/"
...
echo "[Doorstop] Launching: $executable_path"
echo "[Doorstop] DYLD_INSERT_LIBRARIES=$DYLD_INSERT_LIBRARIES"
echo "[Doorstop] DYLD_LIBRARY_PATH=$DYLD_LIBRARY_PATH"
echo "[Doorstop] DOORSTOP_MONO_DEBUG_ENABLED=$DOORSTOP_MONO_DEBUG_ENABLED"
echo "[Doorstop] DOORSTOP_MONO_DEBUG_ADDRESS=$DOORSTOP_MONO_DEBUG_ADDRESS"
echo "[Doorstop] DOORSTOP_MONO_DEBUG_SUSPEND=$DOORSTOP_MONO_DEBUG_SUSPEND"
echo "[Doorstop] Checking libdoorstop exists: $(ls ${doorstop_directory}libdoorstop.dylib 2>&1)"
echo "[Doorstop] Checking codesign entitlements:"
codesign -d --entitlements - "$executable_path" 2>&1 | grep -E "dyld|hardened|cs\." || echo "(no relevant entitlements / not signed)"
